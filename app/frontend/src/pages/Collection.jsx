...
const Collection = () => {
  ...
  // Reaplica o filtro quando as opções mudam
  useEffect(() => {
      applyFilter();
    ...
    <div className='flex flex-col sm:flex-row gap-1 sm:gap-10 pt-10 border-t'>
      ...
      <div className='min-w-[15rem]'>
        ...
        <div className={`border border-gray-300 pl-5 py-3 my-5 ${showFilter ? '' : 'hidden'} sm:block`}>
          ...
          <div className='flex flex-col gap-2 text-sm font-light text-gray-700'>
            <p className='flex gap-2'>
              <input className='w-3' type="checkbox" value={'Topwear'} onChange={toggleSubCategory} /> Superiores
            </p>
            <p className='flex gap-2'>
              <input className='w-3' type="checkbox" value={'Bottomwear'} onChange={toggleSubCategory} /> Inferiores
            </p>
            <p className='flex gap-2'>
      ...
      <div className='flex-1'>
        ...
        <div className='flex justify-between text-base sm:text-2xl mb-4'>
          ...
          <select onChange={(e)=>setSortType(e.target.value)} className='border-2 border-gray-300 text-sm px-2'>
            <option value="relavant">Ordenar por: Relevante</option>
            <option value="low-high">Ordenar por: Menor para Maior</option>
            <option value="high-low">Ordenar por: Maior para Menor</option>
          </select>
        </div>
